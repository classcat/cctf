...
Downloading/unpacking gym
  Downloading gym-0.1.7.tar.gz (139kB): 139kB downloaded
  Running setup.py (path:/home/masao/cctf.proj/venv2/build/gym/setup.py) egg_info for package gym

Requirement already satisfied (use --upgrade to upgrade): numpy>=1.10.4 in /home/masao/cctf.proj/venv2/lib/python2.7/site-packages (from gym)
Downloading/unpacking requests>=2.0 (from gym)
  Downloading requests-2.11.0-py2.py3-none-any.whl (514kB): 514kB downloaded
Requirement already satisfied (use --upgrade to upgrade): six in /home/masao/cctf.proj/venv2/lib/python2.7/site-packages (from gym)
Downloading/unpacking pyglet>=1.2.0 (from gym)
  Downloading pyglet-1.2.4-py2-none-any.whl (964kB): 964kB downloaded
Installing collected packages: gym, requests, pyglet
  Running setup.py install for gym
      File "/home/masao/cctf.proj/venv2/lib/python2.7/site-packages/gym/utils/reraise_impl_py3.py", line 4
...
Successfully installed gym requests pyglet
Cleaning up...
...
summary_dir = './tblogs/cctf_logs/'
summary_interval = 100
# 使われてないw
#checkpoint_path = './model/qlearning.cctf.ckpt'
...
def build_dqn(num_actions, action_repeat):
    ...
    net = cctf.conv_2d(net, 32, 8, strides=4, activation='relu')
    net = cctf.conv_2d(net, 64, 4, strides=2, activation='relu')
    net = cctf.fully_connected(net, 256, activation='relu')
    q_values = cctf.fully_connected(net, num_actions)
...
def build_graph(num_actions):
    ...
    cost = cctf.mean_square(action_q_values, y)
